// sweetalert2@11.26.17 downloaded from https://ga.jspm.io/npm:sweetalert2@11.26.17/dist/sweetalert2.all.js
...
/**
   * @param {object} param
   * @param {HTMLElement} target
   */const Se=(e,t)=>{"jquery"in e?Te(t,e):J(t,e.toString())};
/**
   * @param {HTMLElement} target
   * @param {any} elem
...
/**
   ...
   */const bt=e=>{const t=P();if(!t)return;const o=S();if(e.target===t||o&&o.contains(/** @type {HTMLElement} */e.target)){ut=true;const o=kt(e);wt=o.clientX;mt=o.clientY;pt=parseInt(t.style.insetInlineStart)||0;ht=parseInt(t.style.insetBlockStart)||0;se(t,"swal2-dragging")}};
/**
   * @param {MouseEvent | TouchEvent} event
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const Lt=(e,t)=>{var o;xt(e,t);qe(e,t);At(e,t);ot(e,t);dt(e,t);Bt(e,t);Ie(e,t);et(e,t);Oe(e,t);tt(e,t);const n=P();typeof t.didRender==="function"&&n&&t.didRender(n);(o=i.eventEmitter)===null||o===void 0||o.emit("didRender",n)};const Pt=()=>me(P());const St=()=>{var e;return(e=I())===null||e===void 0?void 0:e.click()};const Tt=()=>{var e;return(e=D())===null||e===void 0?void 0:e.click()};const Ot=()=>{var e;return(e=q())===null||e===void 0?void 0:e.click()};
...
/**
   * @param {KeyboardEvent} event
   * @param {SweetAlertOptions} innerParams
   */const Vt=(e,t)=>{if(!x(t.allowEnterKey))return;const o=P();if(!o||!t.input)return;const n=te(o,t.input);if(e.target&&n&&e.target instanceof HTMLElement&&e.target.outerHTML===n.outerHTML){if(["textarea","file"].includes(t.input))return;St();e.preventDefault()}};
/**
   * @param {KeyboardEvent} event
...
const e=o.querySelectorAll(`[name="${w.radio}"]`);for(let o=0;o<e.length;o++)e[o].disabled=t}else e.disabled=t}function _o(){Vo(this||e,["confirmButton","denyButton","cancelButton"],false)}function Ro(){Vo(this||e,["confirmButton","denyButton","cancelButton"],true)}function Fo(){No(this.getInput(),false)}function Uo(){No(this.getInput(),true)}
/**
...
/**
   * @param {any} elem
   * @returns {boolean}
   */const yn=e=>typeof e==="object"&&e.jquery
/**
   * @param {any} elem
   * @returns {boolean}
...
/**
   ...
   */;const xn=e=>{
/** @type {Record<string, any>} */
const t={};typeof e[0]!=="object"||kn(e[0])?["title","html","icon"].forEach(((o,n)=>{const s=e[n];typeof s==="string"||kn(s)?t[o]=s:s!==void 0&&b(`Unexpected type of ${o}! Expected "string" or "Element", got ${typeof s}`)})):Object.assign(t,e[0]);return t};
/**
...
/**
   ...
   *
   * @returns {boolean}
   */const Sn=()=>Boolean(i.timeout&&i.timeout.isRunning());let Tn=false;
/** @type {Record<string, any>} */const On={};
/**
   * @this {any}
   * @param {string} attr
   */function jn(t="data-swal-template"){On[t]=this||e;if(!Tn){document.body.addEventListener("click",Mn);Tn=true}}
/**
...
/**
   * @param {string} [eventName]
   * @param {EventHandler} [eventHandler]
   */const In=(e,t)=>{i.eventEmitter&&(e?t?i.eventEmitter.removeListener(e,t):i.eventEmitter.removeAllListeners(e):i.eventEmitter.reset())};var qn=Object.freeze({__proto__:null,argsToParams:xn,bindClickHandler:jn,clickCancel:Ot,clickConfirm:St,clickDeny:Tt,enableLoading:ho,fire:Cn,getActions:_,getCancelButton:q,getCloseButton:U,getConfirmButton:I,getContainer:$,getDenyButton:D,getFocusableElements:W,getFooter:R,getHtmlContainer:j,getIcon:S,getIconContent:T,getImage:M,getInputLabel:V,getLoader:N,getPopup:P,getProgressSteps:z,getTimerLeft:En,getTimerProgressBar:F,getTitle:O,getValidationMessage:H,increaseTimer:Pn,isDeprecatedParameter:en,isLoading:X,isTimerRunning:Sn,isUpdatableParameter:Qo,isValidParameter:Go,isVisible:Pt,mixin:An,off:In,on:zn,once:Hn,resumeTimer:Bn,showLoading:ho,stopTimer:$n,toggleTimer:Ln});class Timer{
/**
     * @param {() => void} callback
     * @param {number} delay
     */
...
/**
       ...
       */
s(this,is,/** @type {Promise<SweetAlertResult>} */Promise.resolve({isConfirmed:false,isDenied:false,isDismissed:true}));if(typeof window==="undefined")return;rs=this;const t=Object.freeze(this.constructor.argsToParams(e));
...
/**
       ...
       */
const a=t=>{e.close({isDismissed:true,dismiss:t,isConfirmed:false,isDenied:false})};Ft.swalPromiseResolve.set(e,n);Ft.swalPromiseReject.set(e,s);t.confirmButton.onclick=()=>{Lo(e)};t.denyButton.onclick=()=>{Po(e)};t.cancelButton.onclick=()=>{So(e,a)};t.closeButton.onclick=()=>{a(jt.close)};mn(o,t,a);zt(i,o,a);fo(e,o);Jn(o);us(i,o,a);ws(t,o);setTimeout((()=>{t.container.scrollTop=0}))}));
/**
