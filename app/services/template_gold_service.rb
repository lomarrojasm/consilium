class TemplateGoldService
  def self.activities_matrix
    [
      ...
      [ 1, 1, 2, "Enviar autodiagnóstico '5 áreas clave'", "OPE-003 Autodiagnóstico", "Integral", 1250, 850, 450, 2, 1, 2 ],
      ...
      [ 1, 1, 3, "Presentación de dictamen inicial de hallazgos", "OPE-008 Dictamen de hallazgos", "Integral", 1250, 850, 450, 1, 1, 1 ],
      [ 1, 1, 3, "Solicitar documentos clave", "OPE-009 Lista consolidada de información solicitada", "Integral, Procesos, Comercial", 1250, 850, 450, 2, 1, 3 ],
      [ 1, 1, 4, "Sesión de validación de modelo de negocio", "OPE-010 Preguntas para modelo CANVAS", "Dirección, Procesos, Comercial", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 1, 2, 1, "Presentación de modelo de negocio", "OPE-044 Modelo CANVAS / OPE-011 Minuta de reunión", "Dirección", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 1, 2, 2, "Presentación de Alineación estratégica", "OPE-011 Minuta de reunión", "Dirección", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 1, 3, 3, "Presentación de resultados de dependencia del dueño", "OPE-011 Minuta de reunión", "Procesos", 1250, 850, 450, 2, 2, 0 ],
      ...
      [ 1, 3, 4, "Análisis y elaboración de macro proceso y KPIs", "OPE-016 Base de datos macro proceso", "Procesos", 1250, 850, 450, 2, 8, 8 ],
      [ 1, 3, 4, "Presentación de macroproceso e indicadores clave", "OPE-011 Minuta de reunión", "RH", 1250, 850, 450, 2, 2, 2 ],
      [ 1, 3, 4, "Encuesta de clima organizacional", "OPE-043 Encuesta de clima organizacional", "Integral", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 2, 1, 1, "Elaborar un sistema de gestión y seguimiento a KPIs principales (macro proceso)", "OPE-017 Sistema de seguimiento a KPIs (Macroproceso)", "Integral", 1250, 850, 450, 4, 8, 16 ],
      [ 2, 1, 2, "Presentar y acordar periodicidad de seguimiento a KPIs principales (macroproceso)", "OPE-017 Sistema de seguimiento a KPIs (Macroproceso)", "Integral", 1250, 850, 450, 4, 4, 2 ],
      [ 2, 1, 3, "Documentar y mapear procesos prioritarios", "OPE-018 Documentación de procesos", "Procesos", 1250, 850, 450, 8, 12, 24 ],
      [ 2, 1, 4, "Capacitación en procesos implementados", "OPE-038 Hoja de datos de capacitación", "Procesos", 1250, 850, 450, 8, 12, 24 ],
      [ 2, 2, 1, "Documentar políticas prioritarias", "OPE-019 Documentación de políticas", "Procesos", 1250, 850, 450, 2, 8, 8 ],
      [ 2, 2, 2, "Capacitación en políticas documentadas", "OPE-038 Hoja de datos de capacitación", "Procesos", 1250, 850, 450, 2, 8, 8 ],
      [ 2, 2, 3, "Matriz de responsabilidades (RACI)", "OPE-034 Matriz de responsabilidades (RACI)", "RH", 1250, 850, 450, 2, 8, 8 ],
      [ 2, 2, 4, "Organigrama", "Organigrama", "RH", 1250, 850, 450, 2, 2, 2 ],
      [ 2, 3, 1, "Capacitación y comunicación de matriz de responsabilidades y estructura organizacional", "OPE-038 Hoja de datos de capacitación", "RH", 1250, 850, 450, 4, 8, 16 ],
      [ 2, 3, 2, "Detección de necesidades de capacitación", "OPE-037 Detección de necesidades de capacitación", "Procesos", 1250, 850, 450, 2, 2, 2 ],
      [ 2, 3, 3, "Capacitación Cómo trabajar por procesos (y elegir los más importantes)", "OPE-038 Hoja de datos de capacitación", "Procesos", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 4, 4, "Capacitación Mapa general de procesos y responsables de cada proceso", "OPE-038 Hoja de datos de capacitación", "Procesos", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 4, 4, "Capacitación Indicadores clave por proceso (qué medir y cómo medirlo)", "OPE-038 Hoja de datos de capacitación", "Procesos", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 5, 1, "Capacitación Juntas de seguimiento efectivas (acuerdos y responsables)", "OPE-038 Hoja de datos de capacitación", "Comercial", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 5, 2, "Identificación de segmentos y cliente ideal", "OPE-027 Formato de Identificación de segmentos y cliente ideal", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 2, 6, 1, "Estrategia comercial por segmento (1)", "OPE-028 Formato de estrategia comercial por segmento", "Comercial", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 6, 2, "Estrategia comercial por segmento (2)", "OPE-028 Formato de estrategia comercial por segmento", "Comercial", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 7, 1, "Estrategia comercial por segmento (3)", "OPE-028 Formato de estrategia comercial por segmento", "Procesos", 1250, 850, 450, 4, 12, 24 ],
      [ 2, 7, 2, "Alta y evaluación de proveedores", "OPE-029 Formato de alta y evaluación de proveedores", "Procesos", 1250, 850, 450, 0, 4, 12 ],
      [ 2, 8, 1, "Contrato con proveedores", "OPE-030 Formato de contrato con proveedores", "Procesos, RH", 1250, 850, 450, 2, 4, 12 ],
      [ 2, 8, 2, "Carta responsiva de equipo de TI", "OPE-031 Carta responsiva de equipo de TI", "Dirección", 1250, 850, 450, 1, 2, 12 ],
      [ 2, 8, 3, "Perfil de puestos (Área/Gerencia 1)", "OPE-032 Perfil de puestos", "Finanzas", 1250, 850, 450, 1, 2, 8 ],
      [ 2, 8, 4, "Perfil de puestos (Área/Gerencia 2)", "OPE-032 Perfil de puestos", "Procesos", 1250, 850, 450, 1, 2, 8 ],
      [ 2, 9, 1, "Perfil de puestos (Área/Gerencia 3)", "OPE-032 Perfil de puestos", "Comercial", 1250, 850, 450, 1, 2, 8 ],
      [ 2, 9, 2, "Perfil de puestos (Área/Gerencia 4)", "OPE-032 Perfil de puestos", "RH", 1250, 850, 450, 1, 2, 8 ],
      [ 2, 9, 3, "Perfil de puestos (Área/Gerencia 5)", "OPE-032 Perfil de puestos", "RH", 1250, 850, 450, 1, 2, 8 ],
      [ 2, 9, 4, "Matriz de gestión de empleados", "OPE-041 Matriz de gestión de empleados", "Integral", 1250, 850, 450, 1, 2, 2 ],
      [ 2, 9, 4, "Diagnóstico para membresía", "OPE-020 Diagnóstico para membresía", "Dirección", 1250, 850, 450, 2, 4, 16 ],
      ...
      [ 3, 5, 3, "Documentación de políticas, Política de conflicto de intereses...", "OPE-019 Documentación de políticas", "Dirección, Procesos", 1250, 850, 450, 4, 8, 24 ],
      [ 3, 5, 3, "Documentación de políticas, Política de control de accesos...", "OPE-019 Documentación de políticas", "Dirección, Procesos", 1250, 850, 450, 4, 8, 24 ],
      [ 3, 5, 4, "Capacitación en políticas documentadas", "OPE-038 Hoja de datos de capacitación", "Dirección, Procesos", 1250, 850, 450, 4, 8, 24 ],
      [ 3, 6, 1, "Estandarización de procesos, Proceso de gestión documental...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 4, 8, 24 ],
      [ 3, 6, 2, "Estandarización de procesos, Proceso de gestión de riesgos...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 4, 8, 24 ],
      [ 3, 7, 1, "Estandarización de procesos, Proceso de gestión de quejas...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 2, 4, 12 ],
      ...
      [ 4, 9, 2, "Actualizar perfiles de puesto (Área/ gerencia 3 ,4 y 5)", "OPE-032 Perfil de puestos", "Procesos, Comercial, RH", 1250, 850, 450, 4, 8, 16 ],
      ...
      [ 4, 11, 1, "Estandarización de procesos, Proceso de alta de proveedores...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 4, 11, 2, "Estandarización de procesos, Proceso de gestión de contratos...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 4, 11, 3, "Estandarización de procesos, Proceso de reclutamiento...", "OPE-018 Documentación de procesos", "Dirección, Procesos", 1250, 850, 450, 4, 8, 16 ],
      ...
      [ 4, 12, 1, "Documentación de políticas, Política de recepción de bienes...", "OPE-019 Documentación de políticas", "Dirección, Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 4, 12, 2, "Documentación de políticas, Política de contratación...", "OPE-019 Documentación de políticas", "Dirección, Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 4, 12, 3, "Capacitación en políticas implementadas", "OPE-038 Hoja de datos de capacitacion", "Dirección", 1250, 850, 450, 4, 8, 16 ],
      [ 4, 12, 4, "Elaboración de plan a la medida...", "EST-003 Metodología Consilium", "Dirección", 1250, 850, 450, 1, 2, 2 ],
      [ 4, 12, 4, "Diagnóstico para membresía", "OPE-020 Diagnóstico para membresía", "Integral", 1250, 850, 450, 0, 0, 1 ],

      # --- ETAPA 5 (43 Tareas) ---
      [ 5, 1, 1, "Presentar plan de actividades...", "EST-003 Metodología Consilium", "Integral", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 5, 2, 1, "Capacitación Scaling Up Fase 2", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 4, 4 ],
      [ 5, 2, 2, "Estratos Scaling UP", "SUP-005 Estratos Scaling UP", "Integral", 1250, 850, 450, 4, 4, 4 ],
      [ 5, 2, 3, "Plan estratégico de una pagina Scaling Up", "SUP-006 y SUP-007 Plan estratégico de una pagina Scaling Up", "Integral", 1250, 850, 450, 4, 4, 4 ],
      [ 5, 2, 4, "Resumen de Visión Scaling Up", "SUP-008 Resumen de Visión Scaling Up", "Integral", 1250, 850, 450, 4, 4, 4 ],
      ...
      [ 5, 3, 2, "Cómo hacer la operación más eficiente", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 5, 3, 3, "Detectar y romper cuellos de botella", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 5, 4, 1, "Optimización del flujo de trabajo...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 5, 4, 2, "Estandarizar para crecer...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 5, 4, 3, "Actualizar validación de modelo de negocio...", "OPE-010 Preguntas para modelo CANVAS", "Dirección, Procesos, Comercial", 1250, 850, 450, 4, 8, 12 ],
      ...
      [ 5, 5, 3, "Actualizar macroproceso...", "OPE-016 Base de datos macro proceso", "Procesos", 1250, 850, 450, 8, 12, 24 ],
      [ 5, 5, 4, "Auditorias y conciliaciones aleatorias...", "OPE-020 Conciliación / Pareto de gastos OPE-023", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      [ 5, 6, 1, "Análisis de flujo de efectivo...", "OPE-022 Flujo de efectivo 13 semanas", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      [ 5, 6, 2, "Análisis de pendientes por cobrar...", "OPE-023 Estado de resultados (3 meses)", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      ...
      [ 5, 11, 1, "Estandarización de procesos, Proceso de capacitación...", "OPE-018 Documentación de procesos", "Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 11, 2, "Estandarización de procesos, Proceso de gestión de asistencia...", "OPE-018 Documentación de procesos", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 11, 3, "Estandarización de procesos, Proceso de gestión de accesos a sistemas...", "OPE-018 Documentación de procesos", "RH", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 11, 4, "Capacitación en procesos implementados", "OPE-038 Hoja de datos de capacitación", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 12, 1, "Documentación de políticas, Política de evaluación de desempeño...", "OPE-019 Documentación de políticas", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 12, 2, "Documentación de políticas, Política de disciplina y sanciones...", "OPE-019 Documentación de políticas", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 12, 3, "Capacitación en políticas implementadas", "OPE-038 Hoja de datos de capacitación", "Dirección", 1250, 850, 450, 4, 8, 16 ],
      [ 5, 12, 4, "Elaboración de plan a la medida...", "EST-003 Metodología Consilium", "Dirección", 1250, 850, 450, 1, 2, 2 ],
      [ 5, 12, 4, "Diagnóstico para membresía", "OPE-020 Diagnóstico para membresía", "Integral", 1250, 850, 450, 0, 0, 1 ],

      # --- ETAPA 6 (43 Tareas) ---
      [ 6, 1, 1, "Presentar plan de actividades...", "EST-003 Metodología Consilium", "Integral", 1250, 850, 450, 2, 2, 2 ],
      ...
      [ 6, 2, 1, "Ejecución quien, que cuando Scaling Up", "SUP-009 Ejecución quien, que cuando Scaling Up", "Integral", 1250, 850, 450, 4, 4, 4 ],
      [ 6, 2, 2, "Evaluación de Los hábitos de Rockefeller", "SUP-010 Evaluación de Los hábitos de Rockefeller", "Integral", 1250, 850, 450, 4, 4, 4 ],
      [ 6, 2, 3, "Estrategias de aceleración de efectivo", "SUP-011 Estrategias de aceleración de efectivo", "Integral", 1250, 850, 450, 4, 4, 4 ],
      ...
      [ 6, 3, 2, "Reglas claras de operación y toma de decisiones...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 6, 3, 3, "Delegación y continuidad...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 6, 4, 1, "Prevenir riesgos y errores repetitivos...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 6, 4, 2, "Gestión de proyectos y mejoras...", "OPE-038 Hoja de datos de capacitación", "Integral", 1250, 850, 450, 4, 12, 24 ],
      [ 6, 4, 3, "Actualizar validación de modelo de negocio...", "OPE-010 Preguntas para modelo CANVAS", "Dirección, Procesos, Comercial", 1250, 850, 450, 4, 8, 12 ],
      ...
      [ 6, 5, 3, "Actualizar macroproceso...", "OPE-016 Base de datos macro proceso", "Procesos", 1250, 850, 450, 8, 12, 24 ],
      [ 6, 5, 4, "Auditorias y conciliaciones aleatorias...", "OPE-020 Conciliación / Pareto de gastos OPE-023", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      [ 6, 6, 1, "Análisis de flujo de efectivo...", "OPE-022 Flujo de efectivo 13 semanas", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      [ 6, 6, 2, "Análisis de pendientes por cobrar...", "OPE-023 Estado de resultados (3 meses)", "Finanzas", 1250, 850, 450, 1, 4, 8 ],
      ...
      [ 6, 11, 1, "Estandarización de procesos, Proceso de comunicación interna...", "OPE-018 Documentación de procesos", "Procesos", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 11, 2, "Estandarización de procesos, Proceso de aprobación...", "OPE-018 Documentación de procesos", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 11, 3, "Estandarización de procesos, Proceso de gestión de no conformidades...", "OPE-018 Documentación de procesos", "RH", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 11, 4, "Capacitación en procesos implementados", "OPE-038 Hoja de datos de capacitación", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 12, 1, "Documentación de políticas, Política de salud y seguridad...", "OPE-019 Documentación de políticas", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 12, 2, "Documentación de políticas, Política de seguridad de la información...", "OPE-019 Documentación de políticas", "Comercial", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 12, 3, "Capacitación en políticas implementadas", "OPE-038 Hoja de datos de capacitación", "Dirección", 1250, 850, 450, 4, 8, 16 ],
      [ 6, 12, 4, "Elaboración de plan a la medida...", "EST-003 Metodología Consilium", "Dirección", 1250, 850, 450, 1, 2, 2 ],
    ...
    self.activities_matrix.each_with_index do |row, index|
      ...
      if target_stage
        target_stage.activities.create!(
          ...
          status: "pending",
          completed: false,
          position: index # <-- NUEVO: Guardamos la posición
        )
        actividades_creadas += 1
      end
    end

    Rails.logger.info "✅ Template GOLD (Sin Año) completado exitosamente: #{actividades_creadas} actividades insertadas."
  end
end
